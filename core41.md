...
|-----------------|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|
| binary (tar.gz) | [myfaces-core-assembly-4.1.4-bin.tar.gz](https://www.apache.org/dyn/closer.lua/myfaces/binaries/myfaces-core-assembly-4.1.4-bin.tar.gz) | [myfaces-core-assembly-4.1.4-bin.tar.gz.sha512](https://downloads.apache.org/myfaces/binaries/myfaces-core-assembly-4.1.4-bin.tar.gz.sha512) | [myfaces-core-assembly-4.1.4-bin.tar.gz.asc](https://downloads.apache.org/myfaces/binaries/myfaces-core-assembly-4.1.4-bin.tar.gz.asc) |
| binary (zip)    | [myfaces-core-assembly-4.1.4-bin.zip](https://www.apache.org/dyn/closer.lua/myfaces/binaries/myfaces-core-assembly-4.1.4-bin.zip)       | [myfaces-core-assembly-4.1.4-bin.zip.sha512](https://downloads.apache.org/myfaces/binaries/myfaces-core-assembly-4.1.4-bin.zip.sha512)       | [myfaces-core-assembly-4.1.4-bin.zip.asc](https://downloads.apache.org/myfaces/binaries/myfaces-core-assembly-4.1.4-bin.zip.asc)       |
| source (tar.gz) | [myfaces-core-assembly-4.1.4-src.tar.gz](https://www.apache.org/dyn/closer.lua/myfaces/source/myfaces-core-assembly-4.1.4-src.tar.gz)   | [myfaces-core-assembly-4.1.4-src.tar.gz.sha512](https://downloads.apache.org/myfaces/source/myfaces-core-assembly-4.1.4-src.tar.gz.sha512)   | [myfaces-core-assembly-4.1.4-src.tar.gz.asc](https://downloads.apache.org/myfaces/source/myfaces-core-assembly-4.1.4-src.tar.gz.asc)   |
| source (zip)    | [myfaces-core-assembly-4.1.4-src.zip](https://www.apache.org/dyn/closer.lua/myfaces/source/myfaces-core-assembly-4.1.4-src.zip)         | [myfaces-core-assembly-4.1.4-src.zip.sha512](https://downloads.apache.org/myfaces/source/myfaces-core-assembly-4.1.4-src.zip.sha512)         | [myfaces-core-assembly-4.1.4-src.zip.asc](https://downloads.apache.org/myfaces/source/myfaces-core-assembly-4.1.4-src.zip.asc)         |
...
| o.a.m.EXCEPTION_TYPES_TO_IGNORE_IN_LOGGING | 4.1.1 | | | Defines exceptions, separated by commas, which should be skipped for logging in the ExcceptionHandler. |
...
| o.a.m.VIEWID_EXISTS_CACHE_ENABLED| 2.0.2| true| true, false| Enable or disable the cache used to 'remember' if a view exists or not and reduce the impact " + "of successive calls to ExternalContext.getResource().|
...
| o.a.m.COMPONENT_UNIQUE_IDS_CACHE_SIZE| 2.0.13, 2.1.7| 300| | Set the size of the cache used to store strings generated using SectionUniqueIdCounter for component ids|
